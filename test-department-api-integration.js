// Simple Node.js script to test the department API integration
// Run with: node test-department-api-integration.js

async function testDepartmentAPIIntegration() {
    console.log('Testing Department API Integration with new endpoints...\n');
